...
export default function EditliteraryAgencyModal({ isOpen, itemId, close, literaryAgencyData }) {

    const [username, setUsername] = useState("")
    console.log('isi admin', literaryAgencyData)
    ...
    const initializeData = async () => {
        setUsername(literaryAgencyData?.username)
    }
