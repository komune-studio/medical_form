...
CreateLiteraryAgencyModal.propTypes = {
    ...
    literaryAgencyList: PropTypes.object
};


export default function CreateLiteraryAgencyModal({ isOpen, itemId, close, literaryAgencyList }) {
    ...
    >
        <Modal.Header>
            <Modal.Title>Buat Literary Agency</Modal.Title>
        </Modal.Header>
        <Modal.Body>
            <Form
                name="basic"
